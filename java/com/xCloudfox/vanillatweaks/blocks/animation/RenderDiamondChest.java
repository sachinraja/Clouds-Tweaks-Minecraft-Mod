...
{
	private static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MOD_ID + ":textures/blocks/diamond_chest.png");
	private final ModelDiamondChest MODEL = new ModelDiamondChest();
